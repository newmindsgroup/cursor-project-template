...
- **Stack / tools:** {{STACK}}
- **Repo governance:** consult `/docs` first; maintain `DECISIONS.md`, `ASSUMPTIONS.md`, `QUESTIONS.md`, and `SCOPE.md`; treat `business-context/` and `resource-library/` as read-only reference. Full rules in `.cursorrules` and `.cursor/rules.md`.
